...
enum DXF_DLL DBG_LEVEL {
    NONE,
    DEBUG
};

//! Special codes for colors
enum DXF_DLL ColorCodes {
    ColorByLayer = 256,
    ColorByBlock = 0
};
...
enum DXF_DLL HandleCodes {
    NoHandle = 0
};

//! Shadow mode
enum DXF_DLL ShadowMode {
...
enum DXF_DLL MaterialCodes {
    MaterialByLayer = 0
};

//! Special kinds of plot styles
enum DXF_DLL PlotStyleCodes {
    DefaultPlotStyle = 0
};

//! Special kinds of transparencies
enum DXF_DLL TransparencyCodes {
    Opaque = 0,
    Transparent = -1
};
...
*  @author Rallaz
*/
class DXF_DLL DRW_LW_Conv{
public:
    enum DXF_DLL lineWidth {
